...
/**
 * Created by osama on 06/12/2017.
 */
...
public class VLCPlayer extends AppCompatActivity implements IVLCVout.Callback {
    public final static String TAG = "VLCPlayer";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null && extras.containsKey("videoPath"))
            mFilePath = extras.getString("videoPath");
        else
    ...
    private static class MyPlayerListener implements MediaPlayer.EventListener {
        ...
        public MyPlayerListener(VLCPlayer owner) {
